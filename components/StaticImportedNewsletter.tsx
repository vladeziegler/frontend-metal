...
const StaticImportedNewsletter: React.FC<StaticImportedNewsletterProps> = ({ 
  ...
  const renderSection = (section: ContentSection) => {
    ...
    return (
      <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '0 0 32px 0'}}>
        <tbody>
          <tr>
          ...
          <td>
            <style dangerouslySetInnerHTML={{ __html: `
              @media only screen and (max-width:600px){
                .banking-reinvented  { padding:12px 16px 6px !important; }
                .momentum-headline   { padding:0 16px 6px !important; }
                .by-backbase         { padding:0 16px 0 !important; }
              }
            ` }} />
            ...
            <table align="center" width="650" cellPadding={0} cellSpacing={0} style={{
              ...
              <tbody>
                ...
                <tr>
                  <td
                    align="left"
                    className="banking-reinvented"
                    style={{padding:'20px 0 12px 18px'}}
                  >
                    <img
                ...
                <tr>
                  <td
                    align="left"
                    className="momentum-headline"
                    style={{padding:'8px 18px 12px 18px',fontFamily:'Arial,Helvetica,sans-serif'}}
                  >
                    <h1 style={{fontWeight:900,fontSize:'100px',lineHeight:'80px',color:'#000',margin:0}}>
                      MOMENTUM
                    </h1>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    <img
                      ...
                      width="87"
                      height="16"
                      style={{display:'inline-block',border:0,outline:'none',maxWidth:'100%',height:'auto'}}
                    />
                  </td>
                </tr>
              </tbody>
            ...
            {/* ================= AUTHOR SECTION ================= */}
            <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '50px 0 25px 0'}}>
              <tbody>
                <tr>
                  <td style={{padding: '0 24px'}}>
            ...
            {/* ================= SUBSCRIBE PARAGRAPH ================= */}
            <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '0 0 50px 0', borderBottom: '1px solid #E0E6EB'}}>
              <tbody>
                <tr>
            ...
            {/* ================= SLIDE OF THE WEEK ================= */}
            <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '50px 0'}}>
              <tbody>
                <tr>
                  <td style={{padding: '0 24px'}}>
                    <h2 style={{
            ...
            {/* ================= PODCAST CARD ================= */}
            <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '50px 0', borderBottom: '1px solid #E0E6EB'}}>
              <tbody>
                <tr>
            ...
            {jobTrackingEntries && jobTrackingEntries.length > 0 && (
              <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '50px 0', paddingBottom: '50px', borderBottom: '1px solid #E0E6EB'}}>
                <tbody>
                  <tr>
                    <td style={{padding: '0 24px'}}>
                      <h2 style={{
            ...
            {/* ================= FOOTER ================= */}
            <table width="650" cellPadding={0} cellSpacing={0} style={{margin: '50px 0 0 0', backgroundColor: '#F3F6F9'}}>
              <tbody>
                <tr>
